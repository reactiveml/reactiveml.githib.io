...
\newcommand\sfalse{\mathit{ff}}
\newcommand\strue{\mathit{tt}}
% Types
\newcommand\rt{\tau}
\newcommand\rs{\sigma}
\newcommand\rk{\kappa}
\newcommand{\rkf}{\kappa^{\star}}
...
%\newcommand\rkfinite[1]{\mathtt{fin}(#1)}
\newcommand\rkfinite[1]{#1 \in \rkf}
...
\newcommand\wfexp[2]{#1 \vdash #2}

\newcommand\fbv[1]{\mathit{fbv}(#1)}
