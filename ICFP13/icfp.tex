...
The paper ends with some discussion and examples~(Section~\ref{sec:discussion}) and related work~(Section~\ref{sec:related_work}). The work presented here is implemented in the \rml compiler available at \url{http://reactiveml.org}.
...
\todo{Use a type system guarantees polynomial complexity in practice}
