...
\noindent This unification algorithm also reuse traditional techniques for handling recursive types~\cite{Huet:1975}. Special care has to be taken to unfold recursive rows to reveal the row variable.
...
\todo{Parler de loop: on ne tombe jamais dans le second cas}
\end{itemize}
