...
Using a type-based analysis makes it easy to deal with cases of aliasing, like in the following example:\footnote{The toplevel available at \url{http://reactiveml.org/icfp13/tryrml} can be used to try these examples online}
\begin{lstlisting}
let rec process p =
  let q = (fun x -> x) p in
  run q 
